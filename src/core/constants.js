...
'use strict';
  ...
  const SIMULATION = {
    HOME_ADVANTAGE: 2.5, BASE_SCORE_MIN: 3, BASE_SCORE_MAX: 21, SCORE_VARIANCE: 12,
    MIN_PASS_ATTEMPTS: 22, MAX_PASS_ATTEMPTS: 42, MIN_COMPLETION_PCT: 48, MAX_COMPLETION_PCT: 72,
    MIN_RUSH_ATTEMPTS: 15, MAX_RUSH_ATTEMPTS: 32,
    YARDS_PER_COMPLETION: { MIN: 6, MAX: 13 }, YARDS_PER_CARRY: { MIN: 3, MAX: 5.5 }
  };
