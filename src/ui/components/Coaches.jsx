...
function CoachCard({ coach, onFire, isUserCoach }) {
  if (!coach)
    return (
      <div className="card padding-md text-muted">No Head Coach hired.</div>
    );
    ...
    <div className="card padding-md" style={{ marginBottom: "var(--space-4)" }}>
      ...
      {isUserCoach && (
        <div style={{ marginTop: "var(--space-4)", textAlign: "right" }}>
          <button className="btn btn-danger" onClick={() => onFire(coach)}>
            Fire Coach
          </button>
        </div>
      )}
...
export default function Coaches({ league, actions }) {
  ...
  if (loading && !rosterData)
    return <div className="card padding-md text-muted">Loading coaches...</div>;
          ...
          <table className="standings-table" style={{ width: "100%" }}>
            <thead>
              <tr>
                ...
                <th
                  style={{ textAlign: "right", paddingRight: "var(--space-4)" }}
                >
                  Action
                </th>
              </tr>
