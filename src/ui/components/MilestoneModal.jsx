                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: isBye ? `${color}22` : 'var(--surface-strong)',
  ...
  return (
    ...
    >
      ...
      <button
        className="btn btn-primary"
        onClick={onProceed}
        style={{ marginTop: 'var(--space-4)', minWidth: 240, fontSize: 'var(--text-lg)', fontWeight: 800 }}
      >
...
export default function MilestoneModal({ league, onDismissPlayoffs, onDismissChampion }) {
