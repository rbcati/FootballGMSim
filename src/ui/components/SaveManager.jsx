...
export default function SaveManager({ actions, onCreate }) {
      ...
      if (idbSaves.length === 0) {
        ...
        try {
          ...
          if (manifest.length > 0) {
            setError(
              "Save index recovered from backup. Tap Load to attempt recovery.",
            );
  ...
  return (
    ...
    >
      <div
        className="card"
        style={{ width: "100%", maxWidth: 600, padding: "var(--space-6)" }}
      >
        <h1
          style={{
            textAlign: "center",
              ...
              <div key={save.id} className="save-slot">
                <div className="save-slot-details">
                  ...
                  <div className="muted small">
                    {save.year} Season · {save.teamAbbr} · Last played:{" "}
                ...
                <div className="save-slot-actions">
                  <button
                    ...
                    onClick={() => actions.loadSave(save.id)}
                  >
                    Load
                  </button>
                  <button
