 ...
 * HomeDashboard.jsx
 *
 * A rich "Home" tab that gives the user an at-a-glance view of everything
 * important: team health, next game preview, recent form, injury report,
 * division snapshot, and recent news.
 *
 * Beats Zen GM's minimal standings page by providing real narrative context,
 * and beats Pocket GM's static dashboard by showing live, dynamic data cards.
 */
...
// Recent form dots from last N game results
...
// Get last 5 game results from schedule
...
// Find the user's next unplayed game
...
function SectionCard({ title, icon, children, accent }) {
  return (
    <div style={{
      ...
      border: `1px solid ${accent ? `${accent}33` : "var(--glass-border)"}`,
...
export default function HomeDashboard({ league, onTeamSelect, onPlayerSelect, onTabChange }) {
  ...
  // Injury report: injuries on the user's roster
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "var(--space-4)" }}>
        {/* Team snapshot spans full width */}
