          ...
          <tbody>
            {seasons.map((s) => {
              ...
              return (
                <tr key={s.id}>
                  <td
                    style={{ paddingLeft: "var(--space-5)", fontWeight: 700 }}
                  >
                    {s.year}
                  </td>
                  <td>
                  ...
                  <td>
                    {s.awards?.mvp ? (
                      <span
                        ...
                        onClick={() =>
                          onPlayerSelect &&
                          onPlayerSelect(s.awards.mvp.playerId)
                        }
                        style={{
                          cursor: "pointer",
                          color: "var(--accent)",
                  ...
                  <td>
                    {s.awards?.opoy ? (
                      <span
                        ...
                        onClick={() =>
                          onPlayerSelect &&
                          onPlayerSelect(s.awards.opoy.playerId)
                        }
                  ...
                  <td>
                    {s.awards?.dpoy ? (
                      <span
                        ...
                        onClick={() =>
                          onPlayerSelect &&
                          onPlayerSelect(s.awards.dpoy.playerId)
                        }
                        style={{ cursor: "pointer" }}
                      >
