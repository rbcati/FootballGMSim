...
export default function App() {
  ...
  if (!league) {
    ...
    return (
      <ErrorBoundary>
        <div className="view fade-in" key="saves">
  ...
  return (
    <div className="view fade-in" key={league.seasonId + '-' + league.week + '-' + league.phase} style={{ maxWidth: 1200, margin: '0 auto', padding: 'var(--space-6)' }}>
