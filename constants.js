...
'use strict';
  ...
  const POS_SALARY_WEIGHTS = {
    QB: 1.3, DL: 1.1, WR: 1.05, OL: 1.0, CB: 1.0,
    LB: 0.9, S: 0.8, RB: 0.75, TE: 0.7, K: 0.2, P: 0.2
  };
  ...
  const Constants = {
    ...
    POSITIONS, POS_SALARY_WEIGHTS, OFFENSIVE_POSITIONS, DEFENSIVE_POSITIONS, DEPTH_NEEDS,
