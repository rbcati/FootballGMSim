...
describe('GameDetailV2 tactical recap stability', () => {
  ...
  it('renders rich tactical recap payloads', () => {
    const html = renderToString(
      <GameDetailV2
        game={{
          ...
          developmentFlash: ['Route-running trend improved after sustained target volume.'],
          summary: {
    ...
    expect(html).toContain('Development flash');
    expect(html).toContain('Route-running trend improved after sustained target volume.');
  });
