...
const startNew4 = performance.now();
for (let i = 0; i < ITERATIONS; i++) newWay4();
const endNew4 = performance.now();
...
console.log(`Optimized 4 (map then filter): ${endNew4 - startNew4} ms`);
console.log(`Optimized 2 (grouping loop): ${endNew2 - startNew2} ms`);
